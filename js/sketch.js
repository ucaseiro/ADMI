...
if(proba <= 10){
    ...
    textSize(20)
    text(cse,windowWidth/2+img[6].width/7, windowHeight/2+img[6].height/4.93)
}
    ...
    textSize(22)
    text(saute,windowWidth/2+img[6].width/1000, windowHeight/2+img[6].height/5.05)
}
    ...
    textSize(25)
    text(saute,windowWidth/2+img[6].width/1000, windowHeight/2+img[6].height/4.9)
}
else {
